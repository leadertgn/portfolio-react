...
import { ExternalLink, Github, Youtube, Smartphone, Figma, BookOpen, X, Play } from 'lucide-react'
    ...
    <div className="group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
      ...
      {isModalOpen && currentCaseStudy && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col relative animate-fade-in">
            <button 
              ...
              <div className="space-y-8 text-gray-700 dark:text-gray-300">
                {currentCaseStudy.problem && (
                  <div className="bg-red-50 dark:bg-red-900/10 p-6 rounded-xl border-l-4 border-red-500">
                    ...
                    <p className="leading-relaxed">{currentCaseStudy.problem}</p>
                  </div>
                )}
                ...
                {currentCaseStudy.solution && (
                  <div className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-xl border-l-4 border-blue-500">
                    ...
                    <p className="leading-relaxed whitespace-pre-line">{currentCaseStudy.solution}</p>
                  </div>
                )}
                ...
                {currentCaseStudy.results && (
                  <div className="bg-green-50 dark:bg-green-900/10 p-6 rounded-xl border-l-4 border-green-500">
                    ...
                    <p className="leading-relaxed whitespace-pre-line">{currentCaseStudy.results}</p>
                  </div>
                )}
              </div>
            </div>
